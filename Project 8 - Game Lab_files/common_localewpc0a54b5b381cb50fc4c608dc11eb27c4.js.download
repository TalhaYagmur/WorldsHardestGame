...
(window.locales = window.locales || {}).common_locale = {
  ...
  manageStudentsNotificationAtCapacity: function(d) { return "You can’t have more than 500 students in a section. Questions about this limit? [Contact support](https://code.org/contact)"; },
